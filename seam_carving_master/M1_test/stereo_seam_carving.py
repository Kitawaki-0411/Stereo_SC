...
from my_seam_carve import carve_sample as cs
...
def main():
    # pikleのデータパス
    sbs_cache_filename = "sample_data/sbs.pkl"
    disp_cache_filename = "sample_data/disp.pkl"
    mask_cache_filename = "sample_data/mask.pkl"
    ...
    img_path = "C:/oit/py23/SourceCode/m-research/seam_carving_master/M1_test/sample_data/sbs.png"  # exe_mode = 0 の時に使用する画像
    ...
    scale_down, scale_down_pair = cs.stereo_resize(src, pair, disp, (w - dist, h), keep_mask = mask) # 画像幅(w)から dist だけ増減させる
    ...
    # ==========================================================================================================
    # # サンプルで実行するためのデータ作成
    # save_results(sbs, 'C:/oit/py23/SourceCode/m-research/seam_carving_master/M1_test/sample_data/sbs.pkl')
    # save_results(disp, 'C:/oit/py23/SourceCode/m-research/seam_carving_master/M1_test/sample_data/disp.pkl')
    # save_results(mask, 'C:/oit/py23/SourceCode/m-research/seam_carving_master/M1_test/sample_data/mask.pkl')
    # cv2.imwrite("C:/oit/py23/SourceCode/m-research/seam_carving_master/M1_test/sample_data/result_sbs.png", result_sbs)
    # ==========================================================================================================
